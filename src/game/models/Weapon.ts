...
export class Weapon extends Agent {
    ...
    public constructor(
        ...
        this.achievement_progress = new Map([
            ...
            [WeaponAchievement.FIRST_HEAL, new WeaponAchievementProgress(1)],
            [WeaponAchievement.FIRST_5_HEAL, new WeaponAchievementProgress(5)],
            [WeaponAchievement.FIRST_10_HEAL, new WeaponAchievementProgress(10)],
            [WeaponAchievement.FIRST_50_HEAL, new WeaponAchievementProgress(50)],
            [WeaponAchievement.FIRST_100_HEAL, new WeaponAchievementProgress(100)],
